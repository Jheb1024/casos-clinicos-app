...
function CuestionarioModalContestarAsignado({ quiz, user }) {
    ...
    useEffect(() => {
        ...
        const cuestionarioRef = collection(db, "Resultado");
        const q = query(cuestionarioRef, where("idCuestionario", "==", quiz.idCuestionario), where("idAlumno", "==", user.uid));
                        ...
                        onSubmit={(values, { setSubmitting }) => {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    registrarResultadoCuestionarioAsignado(values, quiz, user).then(cal => {
                                        console.log(cal);
                                        Swal.fire(`Respuestas enviadas! Intento: ${intento+1}.Su calificación es: ${cal}/10.`, '', 'success')
                                    });
                                    setShowresp(true);
