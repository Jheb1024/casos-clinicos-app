...
import { actualizarCuestionario, registrarNuevoCuestionario } from '../../Modelo/AdministrarCuestionarios/administrarCuestionarios'
                ...
                <Modal.Body>
                    <Formik
                        ...
                        onSubmit={(values, { setSubmitting }) => {
                            actualizarCuestionario(values, data).then(()=>{
                                new Swal({
                                    position: 'top-end',
                                    icon: 'succes',
